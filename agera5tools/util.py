...
variable_names = {'Temperature_Air_2m_Mean_24h': dict(variable="2m_temperature", statistic ="24_hour_mean"),
                  ...
                  'Snow_Thickness_LWE_Mean_24h': dict(variable="snow_thickness_lwe", statistic ="24_hour_mean"),
                  'Snow_Thickness_Mean_24h': dict(variable="snow_thickness", statistic ="24_hour_mean"),
                  ...
                  'Derived_Relative_Humidity_2m_Max_24h': dict(variable="2m_relative_humidity_derived", statistic="24_hour_maximum"),
                  'Derived_Relative_Humidity_2m_Min_24h': dict(variable="2m_relative_humidity_derived", statistic="24_hour_minimum"),
